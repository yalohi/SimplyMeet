...
public partial class AdminProfileDataComponent : ComponentBase
{
	//===========================================================================================
	// Global Variables
	//===========================================================================================
	...
	[Parameter] public EventCallback<String> AddClick { get; set; }
	[Parameter] public EventCallback<String> RemoveClick { get; set; }

	private Boolean IsAddDisabled => String.IsNullOrEmpty(_NewName);
	#endregion
	#region Fields
